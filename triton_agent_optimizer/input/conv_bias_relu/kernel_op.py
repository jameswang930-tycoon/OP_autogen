...
# ① Conv2d (host im2col + 标准 GEMM, 走 cube): 每 program 算 (n, oh) 的 [K × OW] 块,
#    x_col 由 main 里 F.unfold 展开 (测量窗口外) — 寻址完全仿射, 规避 HIVM root alloc
#    对 kernel 内 gather 的分析失败 (实测 2D gather 编译报 unsupported)
@triton.jit
